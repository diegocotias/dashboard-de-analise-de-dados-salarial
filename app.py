...
# --- Conteúdo Principal ---
st.title("🎲Dashboar de Análise de Salários na Area de Dados")
st.markdown("Explore os dados salariais na área de dados nos ultimos anos. Utilize os filtros à esquerda para refinar sua analise")
...
st.subheader("📊 Análises Visuais / Gráfico")
